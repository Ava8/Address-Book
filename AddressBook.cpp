...
void AddressBook::showContact(QListWidgetItem *item)
{
...
void AddressBook::on_addContact_clicked()
{
...
void AddressBook::on_deleteBook_clicked()
{
...
void AddressBook::on_contactsList_itemClicked(QListWidgetItem *item)
{
    if (item) {
        showContact(item);
    }
...
void AddressBook::on_deleteContact_clicked()
{
...
void AddressBook::on_editContact_clicked()
{
    if(editDone){
...
void AddressBook::clearContactFields(){
    ui->deleteContact->setEnabled(false);
    ui->editContact->setEnabled(false);
...
void AddressBook::setEditDone(bool ed){
    editDone = ed;
}
